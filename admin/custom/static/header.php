  ...
  <div class="navbar navbar-inverse navbar-static-top" role="navigation">
    <div class="container">
      ...
      <ul class="nav navbar-nav" role="navigation">
        ...
        <li class="hidden"><a href="<?php echo $prefix_url;?>order">Orders</a></li>
        <li class="hidden"><a href="<?php echo $prefix_url;?>customer">Customers</a></li>
        <li class="hidden"><a data-toggle="dropdown" href="#">Products</a>
        ...
        <li class="hidden"><a data-toggle="dropdown" href="#">Promotions</a>
          <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
      ...
      <ul class="nav navbar-nav navbar-right" role="navigation">
        <li class=""><a data-toggle="dropdown" href="#" style="font-size: 18px; padding: 14px 6px 14px 10px"><span class="glyphicon glyphicon-cog"></span></a>
          <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
            ...
            <li class="hidden"><a href="<?php echo $prefix_url;?>notifications">Notifications</a></li>
            <li class="hidden"><a href="<?php echo $prefix_url;?>payment">Payment</a></li>
            <li class="hidden"><a href="<?php echo $prefix_url;?>shipping">Shipping Methods</a></li>
