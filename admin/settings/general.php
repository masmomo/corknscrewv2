      ...
      <div class="box row">
        ...
        <div class="content col-xs-9">
          <ul class="form-set">
            ...
            <li class="form-group row">
              <label class="control-label col-xs-3" for="website-name">Website Keywords <span>*</span></label>
              <div class="col-xs-9">
                ...
                <p class="help-block">Keywords for your website</p>
              </div>
            </li>
            <li class="form-group row">
      ...
      <div class="box row">
        ...
        <div class="content col-xs-9">
          <ul class="form-set">
            ...
            <li class="form-group row underlined hidden">
            ...
            <li class="form-group row">
              ...
              <div class="col-xs-9">
                <input type="text" class="form-control" id="twitter" name="company_instagram" placeholder="http://www.twitter.com/username" value="<?php echo $general['company_instagram'];?>">
              </div>
            </li>
          </ul>
        </div>
