...
if(isset($_POST['btn_general_index'])){
   ...
   if($validation['rows'] > 0){
      update_general($url, $title, $description, $keywords, $analytics, $phone, $address, $country, $province, $city, $postal, $facebook, $twitter, $instagram, $currency, $logo);   
   }else{
      insert_general($url, $title, $description, $keywords, $analytics, $phone, $address, $country, $province, $city, $postal, $facebook, $twitter, $instagram, $currency, $logo);
   }
